 ...
 * Add Middlewares
 */
app.use(morgan('combined', {"stream": require('config').morganStream}));
app.use(helmet());
 ...
 */
app.use('/', require('./apps/webapp'));


/**
 * Plug socket.io app here
 */
// Initialize socket handler for the game
require('./apps/socket').socketHandler(io);
